...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<?> handler(TaskNotFoundException e){
		return new ResponseEntity<>("Task not found with given id , Please Check"
	...
	public ResponseEntity<?> handlerNotSupported(HttpRequestMethodNotSupportedException e){
		return new ResponseEntity<>("Please make a valid request For Task , Please check"
	...
	public ResponseEntity<?> handlerNotReadable(HttpMessageNotReadableException e){
		return new ResponseEntity<>("Please provide Task details in request body.?"
